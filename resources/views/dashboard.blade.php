...
<body>
        ...
        <div class="mx-4 flex items-center justify-between">
            ...
            <div class="relative">
                <button id="dropdownButton" class="focus:outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline-block text-orange-500" fill="none"
                ...
                <div class="absolute right-0 mt-2">
                    <ul id="dropdownMenu" action="{{ route('logout') }}" method="POST"
                        class="bg-orange text-white py-1 px-2 rounded-lg opacity-0 transition duration-300 transform scale-95 origin-top-right focus-within:opacity-100 focus-within:scale-100"
                        style="display: none;">
                        <li>
                            @csrf
            ...
            <div class="flex flex-col w-full bg-white rounded-xl shadow-md shadow-black/25 divide-y">
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        ...
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">bbl</p>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">HKLD</p>
                        <p class="text-pdu-orange ms-1" id="hkldp">N/A</p>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">ROP</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">m/hr</p>
                    </div>
                </div>

                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">Bit Hours</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">hr</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">MW In</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">ppg</p>
                    </div>
                </div>

                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">MW Out</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">ppg</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">MFO Aerated</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">%</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">Pump Hour</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">hr</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">Drill Rev</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">krev</p>
                    </div>
                </div>

                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">TVD</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">m</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">MWD Temp</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">°C</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">CSIP</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">psi</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">Blooie Line Temp</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">klb</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row py-2 align-middle font-bold text-base">
                        <p class="text-black ms-4">RPMM</p>
                        <p class="text-pdu-orange ms-1" id="">N/A</p>
                        <p class="text-pdu-orange ms-1">-</p>
                    </div>
                </div>
    ...
    <main class="relative">
        <div id="shadow_layer" class="absolute top-0 left-0 w-full h-full bg-black opacity-50 z-10"
                            ...
                            <ul role="list" class="divide-y w-full divide-gray-300">
                                ...
                                <li class="grid grid-cols-[auto,1fr] py-2 items-center">
                                    <div class="flex min-w-0 inline-block items-center">
                                        ...
                                        <div class="flex-col min-w-0 flex-auto items-center">
                                            <p class="text-base truncate font-bold" style="color: #60D96C;">Block
                                                Position</p>
                                            <p class="mt-1 truncate font-bold text-base text-gray-300">
                                                <span id="BlockVal" style="color: #60D96C;">N/A</span> /
                                                <span>35</span>
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <ul role="list" class="divide-y w-full divide-gray-300">
                                ...
                                <li class="grid grid-cols-[auto,1fr] py-2 items-center">
                                    <div class="flex min-w-0 inline-block items-center">
                                        ...
                                        <div class="flex-col min-w-0 flex-auto items-center">
                                            <p class="text-base truncate font-bold" style="color: #C33AC8;">Backside
                                                Flow</p>
                                            <p class="mt-1 truncate font-bold text-base text-gray-300">
                                                <span id="BacksideVal" style="color: #C33AC8;">N/A</span> /
                                                <span>1200</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <li class="grid grid-cols-[auto,1fr] pt-2 items-center">
                                    <div class="flex min-w-0 inline-block items-center">
                                        ...
                                        <div class="flex-col min-w-0 flex-auto items-center">
                                            <p class="text-base truncate font-bold" style="color: #666E40;">Pit Volume
                                                Act</p>
                                            <p class="mt-1 truncate font-bold text-base text-gray-300">
                                                <span id="PitVolumeVal" style="color: #666E40;">N/A</span> /
                                                <span>1000</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <li class="grid grid-cols-[auto,1fr] pb-2 items-center">
                                    <div class="flex min-w-0 inline-block items-center">
                                        ...
                                        <div class="flex-col min-w-0 flex-auto items-center">
                                            ...
                                            <p class="mt-1 truncate font-bold text-base text-gray-300">
                                                <span id="MWOutVal" style="color: #B10303;">N/A</span> /
                                                <span>10</span>
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <ul role="list" class="divide-y w-full divide-gray-300">
                                <li class="grid grid-cols-[auto,1fr] pb-2 items-center">
                                    <div class="flex min-w-0 inline-block items-center">
                                        ...
                                        <div class="flex-col min-w-0 flex-auto items-center">
                                            <p class="text-base truncate font-bold" style="color: #771960;">H2S Shaker
                                            </p>
                                            <p class="mt-1 truncate font-bold text-base text-gray-300">
                                                <span id="H2SShakerVal" style="color: #771960;">N/A</span> /
                                                <span>200</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <li class="grid grid-cols-[auto,1fr] py-2 items-center">
                                    <div class="flex min-w-0 inline-block items-center">
                                        ...
                                        <div class="flex-col min-w-0 flex-auto items-center">
                                            <p class="text-base truncate font-bold" style="color: #3F2E97;">H2S Cellar
                                            </p>
                                            <p class="mt-1 truncate font-bold text-base text-gray-300">
                                                <span id="H2SCellarVal" style="color: #3F2E97;">N/A</span> /
                                                <span>20</span>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <li class="grid grid-cols-[auto,1fr] pt-2 items-center">
                                    <div class="flex min-w-0 inline-block items-center">
                                        ...
                                        <div class="flex-col min-w-0 flex-auto items-center">
                                            <p class="text-base truncate font-bold" style="color: #4AC599;">H2S Mud
                                                Pond</p>
                                            <p class="mt-1 truncate font-bold text-base text-gray-300">
    ...
    <div id="dashboard-container" data-well-id="{{ $well_id }}"></div>
    <div id="company-data" data-company-id="{{ $company_id }}"></div>
</body>
